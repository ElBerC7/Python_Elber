...
payasos = int(input("¿Cuátos payasos vendió en el último pedido?: "))
muñecas = int(input("¿Cuátos payasos vendió en el último pedido?: "))
peso = payasos * 112 + muñecas * 75

print(f"El peso total del paquete a enviar es: {peso}")